...
public class SWRLBuiltInLibraryImpl extends AbstractSWRLBuiltInLibrary
{
  ...
  {   
    ...
    Geometry geom1=getArgumentAsAGeometry(0, arguments);// AString(argument1Number, arguments);
  ...
  {   
    ...
    if(st_isLineString(arguments)) {
        LineString geom1=(LineString)(Object)getLiteralArgumentAsAString(0, arguments);// AString(argument1Number, arguments);
